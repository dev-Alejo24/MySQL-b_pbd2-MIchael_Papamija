...
CREATE TABLE `customer_phone` (
  ...
  CONSTRAINT `customer_phone_ibfk_1` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id_customer`)
...
INSERT INTO `customer_phone` VALUES (1,1,'1234567890'),(2,1,'0987654321'),(3,2,'9876543210'),(4,3,'1111111111'),(5,4,'2222222222'),(6,5,'3333333333');
